...
const PACKAGE_ID = 'dsh-usage'
const CSS_PREFIX = '\0dsh-usage-css:'
const CSS_SUFFIX = '.mjs'

/** Compile CSS Modules and inject plugin-owned styles that the Harness loader can unload. */
function cssModules(): NonNullable<UserConfig['plugins']>[number] {
  return {
